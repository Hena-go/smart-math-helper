...
def get_tips(level):
    if level == "مبتدئ":
        return (
            '<img src="https://img.icons8.com/ios/50/teacher.png" width="25"/> **نصائح للمربي:** استخدم أدوات بصرية مثل قطع الكسور أو الفواكه.',
            '<img src="https://img.icons8.com/ios/50/student-male.png" width="25"/> **نصائح للطالب:** حاول تقسيم أشياء حولك إلى أنصاف وأرباع لتفهم الكسر عمليًا.'
        )
    elif level == "متوسط":
        return (
            '<img src="https://img.icons8.com/ios/50/teacher.png" width="25"/> **نصائح للمربي:** شجع الطالب على إجراء عمليات جمع وطرح بسيطة للكسور.',
            '<img src="https://img.icons8.com/ios/50/student-male.png" width="25"/> **نصائح للطالب:** تدرب على مقارنة الكسور وتبسيطها.'
        )
    else:
        return (
            '<img src="https://img.icons8.com/ios/50/teacher.png" width="25"/> **نصائح للمربي:** شجع الطالب على ربط الكسور بالحياة اليومية (مثل الطهي أو الوقت).',
            '<img src="https://img.icons8.com/ios/50/student-male.png" width="25"/> **نصائح للطالب:** جرب حل مسائل منوعة تشمل ضرب وطرح الكسور وتطبيقها في مواقف حقيقية.'
        )

# --- فيديو توضيحي ---
def get_video_url(level):
    if level == "مبتدئ":
        return "https://www.youtube.com/watch?v=At6VjUqah6A"
    elif level == "متوسط":
        return "https://www.youtube.com/watch?v=3v6tw7v2D7Q"
    else:
        return "https://www.youtube.com/watch?v=YJPl1v9aL2k"
...
if name:
    ...
    if st.button("أرسل الإجابات"):
        ...
        st.markdown("### 📘 نصائح:")
        st.markdown(tips_teacher, unsafe_allow_html=True)
        st.markdown(tips_student, unsafe_allow_html=True)
